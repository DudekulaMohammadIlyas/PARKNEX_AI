...
export default function ScanScreen({ navigation }) {
  // In a real app, this would use expo-camera. For UI mapping, we use a placeholder view.
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: '#FAFBFF' }]}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 24, paddingBottom: 10 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: '900', color: COLORS.text, marginLeft: 16 }}>Vehicle Entry Scan</Text>
      </View>
      <Text style={{ fontSize: 16, color: COLORS.textMuted, textAlign: 'center', marginBottom: 24 }}>Point camera at the number plate</Text>

      {/* Camera Viewfinder Mock */}
      <View style={{ flex: 1, paddingHorizontal: 24, paddingBottom: 40 }}>
        <View style={{ flex: 1, backgroundColor: '#E2E8F0', borderRadius: 32, overflow: 'hidden', borderWidth: 4, borderColor: COLORS.white, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 20, elevation: 5 }}>
          ...
          <View style={{ position: 'absolute', bottom: 24, left: 24, right: 24 }}>
            ...
            >
              ...
              <Text style={{ color: COLORS.white, fontSize: 16, fontWeight: '800' }}>Tap to Scan</Text>
            </TouchableOpacity>
          </View>
